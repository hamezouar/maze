...
class Mazegenerator:
    ...
    def protect_42(self, grid: List[List[Cell]]) -> Set[Tuple[int, int]]:
        ...
        point2 = [(my, mx + 1), (my, mx + 2), (my, mx + 3), (my - 1, mx + 3),
                  (my - 2, mx + 3), (my - 2, mx + 1), (my - 2, mx + 2),
                  (my + 1, mx + 1), (my + 2, mx + 1), (my + 2, mx + 2),
                  (my + 2, mx + 3)]
        point4 = [(my, mx - 1), (my, mx - 2), (my, mx - 3), (my - 1, mx - 3),
                  (my - 2, mx - 3), (my + 1, mx - 1), (my + 2, mx - 1)]
        point42 = set(point2 + point4)
